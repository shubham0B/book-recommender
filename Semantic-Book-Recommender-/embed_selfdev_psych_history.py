        ...
        for page in range(1, 15):
            ...
            try:
                ...
                for d in docs:
                    ...
                    desc = f"An insightful and transformative work on {subj_str.lower()} by {authors_str}."
...
def fetch_from_google_books(genre_type: str, queries: List[str], existing_ids: Set[str], existing_keys: Set[str], target: int) -> List[Dict[str, Any]]:
    ...
    code_map = {"Self Development": "sd", "Psychology": "psy", "History": "his"}
    prefix_code = code_map.get(genre_type, "gen")
        ...
        for start_idx in range(0, 80, 40):
            ...
            try:
                ...
                for item in items:
                    ...
                    clean_desc = normalize_string(raw_desc) or f"An influential work on {genre_type.lower()} by {authors_str}."
...
def run():
    # 1. Self Development (2000 books)
    sd_subjects = [
        "self-help", "personal_development", "success", "productivity",
        "motivation", "habits", "leadership", "mindset", "time_management",
        "goal_setting", "happiness", "emotional_intelligence", "mindfulness"
    ]
    sd_google = [
        'subject:"self-help"', 'subject:"personal development"', 'subject:"success"', 'subject:"productivity"',
        'inauthor:"James Clear"', 'inauthor:"Dale Carnegie"', 'inauthor:"Stephen R. Covey"',
        'inauthor:"Simon Sinek"', 'inauthor:"Brene Brown"', 'inauthor:"Mark Manson"',
        'inauthor:"Cal Newport"', 'inauthor:"Tim Ferriss"', 'inauthor:"Robert Greene"',
        'inauthor:"Ryan Holiday"', 'inauthor:"Carol S. Dweck"', 'inauthor:"Tony Robbins"',
        'inauthor:"Eckhart Tolle"', 'inauthor:"Gretchen Rubin"'
    ]
    embed_genre_dataset("Self Development", 2000, sd_subjects, sd_google)

    # 2. Psychology (2000 books)
    psy_subjects = [
        "psychology", "cognitive_psychology", "behavioral_psychology", "social_psychology",
        "developmental_psychology", "neuropsychology", "psychoanalysis", "mental_health",
        "psychiatry", "psychotherapy", "clinical_psychology", "human_behavior"
    ]
    psy_google = [
        'subject:"psychology"', 'subject:"cognitive psychology"', 'subject:"behavioral psychology"',
        'inauthor:"Daniel Kahneman"', 'inauthor:"Sigmund Freud"', 'inauthor:"Carl Jung"',
        'inauthor:"Oliver Sacks"', 'inauthor:"Steven Pinker"', 'inauthor:"Dan Ariely"',
        'inauthor:"Malcolm Gladwell"', 'inauthor:"Jonathan Haidt"', 'inauthor:"Robert Cialdini"',
        'inauthor:"Philip Zimbardo"', 'inauthor:"Mihaly Csikszentmihalyi"', 'inauthor:"Bessel van der Kolk"',
        'inauthor:"Viktor Frankl"', 'inauthor:"Jordan Peterson"'
    ]
    embed_genre_dataset("Psychology", 2000, psy_subjects, psy_google)

    # 3. History (2000 books)
    his_subjects = [
        "history", "world_history", "ancient_history", "modern_history",
        "military_history", "european_history", "american_history", "asian_history",
        "roman_empire", "renaissance", "world_war_ii", "middle_ages", "civilization"
    ]
    his_google = [
        'subject:"history"', 'subject:"world history"', 'subject:"ancient history"', 'subject:"military history"',
        'inauthor:"Yuval Noah Harari"', 'inauthor:"David McCullough"', 'inauthor:"Doris Kearns Goodwin"',
        'inauthor:"Ron Chernow"', 'inauthor:"Antony Beevor"', 'inauthor:"Dan Carlin"',
        'inauthor:"Howard Zinn"', 'inauthor:"Peter Frankopan"', 'inauthor:"Jared Diamond"',
        'inauthor:"Max Hastings"', 'inauthor:"Barbara Tuchman"', 'inauthor:"William Shirer"',
        'inauthor:"Mary Beard"', 'inauthor:"Tom Holland" history'
    ]
    embed_genre_dataset("History", 2000, his_subjects, his_google)
