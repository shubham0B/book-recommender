        ...
        for page in range(1, 15):
            ...
            try:
                ...
                for d in docs:
                    ...
                    prefix = "ol_fan" if genre_type == "Fantasy" else "ol_sf"
                    ...
                    desc = f"An enthralling {genre_type.lower()} masterpiece exploring {subj_str.lower()} by {authors_str}."
        ...
        for start_idx in range(0, 80, 40):
            ...
            try:
                ...
                for item in items:
                    ...
                    gb_id = item.get("id", "")
                    prefix = "gb_fan" if genre_type == "Fantasy" else "gb_sf"
                    ...
                    clean_desc = normalize_string(raw_desc) or f"An epic {genre_type.lower()} novel by {authors_str}."
...
def run():
    # 1. Fantasy (2000 books)
    fan_subjects = [
        "fantasy", "epic_fantasy", "high_fantasy", "urban_fantasy",
        "magic_fiction", "mythology_fiction", "dark_fantasy", "sword_and_sorcery",
        "dragons_fiction", "wizards_fiction", "fairy_tales_fiction", "arthurian_romances"
    ]
    fan_google = [
        'subject:"epic fantasy"', 'subject:"high fantasy"', 'subject:"urban fantasy"', 'subject:"fantasy fiction"',
        'inauthor:"J.R.R. Tolkien"', 'inauthor:"George R.R. Martin"', 'inauthor:"Brandon Sanderson"',
        'inauthor:"Terry Pratchett"', 'inauthor:"Neil Gaiman"', 'inauthor:"Patrick Rothfuss"',
        'inauthor:"Robert Jordan"', 'inauthor:"Ursula K. Le Guin"', 'inauthor:"Robin Hobb"',
        'inauthor:"Andrzej Sapkowski"', 'inauthor:"Joe Abercrombie"', 'inauthor:"Steven Erikson"',
        'inauthor:"Jim Butcher"', 'inauthor:"Leigh Bardugo"', 'inauthor:"Sarah J. Maas"'
    ]
    embed_genre_dataset("Fantasy", 2000, fan_subjects, fan_google)

    # 2. Science Fiction (2000 books)
    sf_subjects = [
        "science_fiction", "space_opera", "cyberpunk", "hard_science_fiction",
        "time_travel_fiction", "dystopian_fiction", "post-apocalyptic_fiction",
        "alien_contact", "artificial_intelligence_fiction", "steampunk",
        "military_science_fiction", "interplanetary_voyages"
    ]
    sf_google = [
        'subject:"science fiction"', 'subject:"space opera"', 'subject:"hard science fiction"', 'subject:"cyberpunk"',
        'inauthor:"Isaac Asimov"', 'inauthor:"Arthur C. Clarke"', 'inauthor:"Philip K. Dick"',
        'inauthor:"Frank Herbert"', 'inauthor:"William Gibson"', 'inauthor:"Ray Bradbury"',
        'inauthor:"Orson Scott Card"', 'inauthor:"Dan Simmons"', 'inauthor:"Neal Stephenson"',
        'inauthor:"Cixin Liu"', 'inauthor:"Andy Weir"', 'inauthor:"Blake Crouch"',
        'inauthor:"Alastair Reynolds"', 'inauthor:"Peter F. Hamilton"', 'inauthor:"Adrian Tchaikovsky"',
        'inauthor:"Ann Leckie"', 'inauthor:"Ted Chiang"', 'inauthor:"John Scalzi"'
    ]
    embed_genre_dataset("Science Fiction", 2000, sf_subjects, sf_google)
