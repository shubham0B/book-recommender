        ...
        for page in range(1, 15):
            ...
            try:
                ...
                for d in docs:
                    ...
                    desc = f"A gripping {genre_type.lower()} novel exploring {subj_str.lower()} by {authors_str}."
...
def fetch_from_google_books(genre_type: str, queries: List[str], existing_ids: Set[str], existing_keys: Set[str], target: int) -> List[Dict[str, Any]]:
    ...
    code_map = {"Mystery": "mys", "Thriller": "thr", "Romance": "rom"}
    prefix_code = code_map.get(genre_type, "gen")
        ...
        for start_idx in range(0, 80, 40):
            ...
            try:
                ...
                for item in items:
                    ...
                    clean_desc = normalize_string(raw_desc) or f"An exciting and bestselling {genre_type.lower()} novel by {authors_str}."
...
def run():
    # 1. Mystery (2000 books)
    mys_subjects = [
        "mystery", "detective_fiction", "crime_fiction", "cozy_mystery",
        "murder_mystery", "police_procedural", "whodunit", "private_investigators",
        "amateur_sleuths", "legal_mystery", "historical_mystery"
    ]
    mys_google = [
        'subject:"mystery fiction"', 'subject:"detective fiction"', 'subject:"crime mystery"',
        'inauthor:"Agatha Christie"', 'inauthor:"Arthur Conan Doyle"', 'inauthor:"Michael Connelly"',
        'inauthor:"Louise Penny"', 'inauthor:"Raymond Chandler"', 'inauthor:"Dashiell Hammett"',
        'inauthor:"Anthony Horowitz"', 'inauthor:"Tana French"', 'inauthor:"Robert Galbraith"',
        'inauthor:"Richard Osman"', 'inauthor:"Ruth Ware"', 'inauthor:"Lucy Foley"',
        'inauthor:"Karin Slaughter"', 'inauthor:"Ian Rankin"', 'inauthor:"Ann Cleeves"'
    ]
    embed_genre_dataset("Mystery", 2000, mys_subjects, mys_google)

    # 2. Thriller (2000 books)
    thr_subjects = [
        "thriller", "psychological_thriller", "suspense_fiction", "espionage",
        "spy_fiction", "legal_thriller", "medical_thriller", "techno_thriller",
        "political_thriller", "action_and_adventure"
    ]
    thr_google = [
        'subject:"thriller fiction"', 'subject:"psychological thriller"', 'subject:"suspense thriller"',
        'inauthor:"Gillian Flynn"', 'inauthor:"Lee Child"', 'inauthor:"John le Carre"',
        'inauthor:"David Baldacci"', 'inauthor:"James Patterson" thriller', 'inauthor:"Harlan Coben"',
        'inauthor:"Dan Brown"', 'inauthor:"John Grisham"', 'inauthor:"Alex Michaelides"',
        'inauthor:"Paula Hawkins"', 'inauthor:"Shari Lapena"', 'inauthor:"B.A. Paris"',
        'inauthor:"Lisa Jewell"', 'inauthor:"Gregg Hurwitz"', 'inauthor:"Tom Clancy"'
    ]
    embed_genre_dataset("Thriller", 2000, thr_subjects, thr_google)

    # 3. Romance (2000 books)
    rom_subjects = [
        "romance", "contemporary_romance", "historical_romance", "romantic_comedy",
        "regency_romance", "paranormal_romance", "romantic_suspense", "erotic_romance", "love_stories"
    ]
    rom_google = [
        'subject:"romance fiction"', 'subject:"contemporary romance"', 'subject:"historical romance"',
        'inauthor:"Jane Austen"', 'inauthor:"Colleen Hoover"', 'inauthor:"Emily Henry"',
        'inauthor:"Ali Hazelwood"', 'inauthor:"Julia Quinn"', 'inauthor:"Nicholas Sparks"',
        'inauthor:"Nora Roberts"', 'inauthor:"Lisa Kleypas"', 'inauthor:"Sarah MacLean"',
        'inauthor:"Tessa Dare"', 'inauthor:"Helen Hoang"', 'inauthor:"Christina Lauren"',
        'inauthor:"Jojo Moyes"', 'inauthor:"Sally Thorne"', 'inauthor:"Taylor Jenkins Reid"'
    ]
    embed_genre_dataset("Romance", 2000, rom_subjects, rom_google)
