...
export function BookCoverImage({
  ...
  if (title) {
    const backendUrl = `http://localhost:8000/api/books/cover?title=${encodeURIComponent(title)}&author=${encodeURIComponent(author || '')}&isbn=${encodeURIComponent(cleanIsbn || '')}`
